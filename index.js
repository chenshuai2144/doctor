...
switch (platform) {
    ...
    switch (arch) {
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "doctor.android-arm64.node")
        );
        try {
          if (localFileExisted) {
      ...
      case "arm":
        localFileExisted = existsSync(
          join(__dirname, "doctor.android-arm-eabi.node")
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./doctor.android-arm-eabi.node");
          } else {
            nativeBinding = require("@umijs/doctor-android-arm-eabi");
          }
        } catch (e) {
          loadError = e;
        }
  ...
  case "darwin":
    localFileExisted = existsSync(
      join(__dirname, "doctor.darwin-universal.node")
    );
    try {
      if (localFileExisted) {
        nativeBinding = require("./doctor.darwin-universal.node");
      } else {
        nativeBinding = require("@umijs/doctor-darwin-universal");
      }
      break;
    } catch {}
    switch (arch) {
  ...
  case "linux":
    switch (arch) {
      ...
      case "arm":
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, "doctor.linux-arm-musleabihf.node")
          );
          try {
            if (localFileExisted) {
              nativeBinding = require("./doctor.linux-arm-musleabihf.node");
            } else {
              nativeBinding = require("@umijs/doctor-linux-arm-musleabihf");
            }
          } catch (e) {
            loadError = e;
          }
      ...
      case "riscv64":
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, "doctor.linux-riscv64-musl.node")
          );
          try {
            if (localFileExisted) {
              nativeBinding = require("./doctor.linux-riscv64-musl.node");
            } else {
              nativeBinding = require("@umijs/doctor-linux-riscv64-musl");
            }
          } catch (e) {
            loadError = e;
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, "doctor.linux-riscv64-gnu.node")
          );
          try {
            if (localFileExisted) {
              nativeBinding = require("./doctor.linux-riscv64-gnu.node");
            } else {
              nativeBinding = require("@umijs/doctor-linux-riscv64-gnu");
            }
          } catch (e) {
            loadError = e;
          }
      ...
      case "s390x":
        localFileExisted = existsSync(
          join(__dirname, "doctor.linux-s390x-gnu.node")
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./doctor.linux-s390x-gnu.node");
          } else {
            nativeBinding = require("@umijs/doctor-linux-s390x-gnu");
          }
        } catch (e) {
          loadError = e;
        }
...
const { genChangelogs, genAllChangelogs, checkPublish } = nativeBinding;
